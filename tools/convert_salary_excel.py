...
COMPANY_PATTERNS = {"company", "employer", "organization", "firm"}
CITY_PATTERNS = {"city", "location", "province", "region"}
COUNT_PATTERNS = {"count", "number", "n", "employees", "headcount"}
INDEX_PATTERNS = {"index", "idx", "salary", "median", "average", "compensation"}
